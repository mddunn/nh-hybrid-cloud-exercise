...
-- Insert Products
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_name, last_update_time) values(1, 'Pork - Caul Fat', '$5.63', 19, '87-017-4611', '2022-07-11 18:58:42'::timestamp);
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_name, last_update_time) values(2, 'Tarragon - Primerba, Paste', '$27.94', 27, '51-894-3698', '2022-07-09 20:05:52'::timestamp);
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_name, last_update_time) values(3, 'Bagel - Ched Chs Presliced', '$18.01', 23, '79-156-2194', '2022-07-10 04:32:17'::timestamp);
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_name, last_update_time) values(4, 'V8 Splash Strawberry Kiwi', '$33.85', 46, '50-617-6068', '2022-07-08 12:52:26'::timestamp);
insert into grocery_shop.products (product_id, product_name, product_cost, product_quantity, seller_name, last_update_time) values(5, 'Potatoes - Yukon Gold, 80 Ct', '$33.92', 32, '35-950-3000', '2022-07-11 07:09:15'::timestamp);
